...
- (void)viewDidLoad
{
    ...
    [self.detector beginDetecting:kMachineAndFaceMetaData
               ...
               withDetectionBlock:^(SMKDetectionOptions detectionType, NSArray *detectedObjects, CGRect clapOrRectZero) {
                   ...
                   if (detectedObjects.count > 0) {
                       if ([_qrString length] == 0){
                           ...
                           _qrString = [[detectedObjects objectAtIndex:0] stringValue];
                           
                           [self performSegueWithIdentifier:@"ShowQR" sender:nil];
                           
                           _qrString = nil;
                           
                           [self.detector stopCameraCapture];
                       }
//
...
- (IBAction)rotateCamera:(UISwitch *)sender
{
    ...
    sender.on = ([self.detector cameraPosition] == AVCaptureDevicePositionBack);
}
